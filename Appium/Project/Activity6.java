...
public class Activity6 {
	...
	public void navigateToSite() throws InterruptedException {
		...
		driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).scrollForward(30).scrollForward(30).scrollForward(30).scrollIntoView(new UiSelector().textContains(\"Popups\"));"));

		driver.findElement(MobileBy.xpath("//android.view.View[starts-with(@text,'Popups')]")).click();
		Thread.sleep(2000);
	}
